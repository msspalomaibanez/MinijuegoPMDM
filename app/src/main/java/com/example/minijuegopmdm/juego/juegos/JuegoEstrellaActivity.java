 ...
 * jugar
 */
public class JuegoEstrellaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Recogemos de la clase anterior (MenuEstrellaActivity) el nombre del usuario para poder usarlo
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(JuegoEstrellaActivity.this);
    ...
    public void crearTablero() {
        ...
        int heroe = getResources().getIdentifier("heroe_estrella", "drawable", getPackageName());
    ...
    public int siguienteCasillaHeroe(int dado, AdaptadorJuego adapter) {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (adapter.getItem(i).getImagen() == R.drawable.heroe_estrella) {
            ...
            if (adapter.getItem(i).getImagen() == R.drawable.seleccion) {
                ...
                grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        //Compruebo las casillas a las que se puede mover el heroe (solo las de selección)
                        if (adapter.getItem(i).getImagen() == R.drawable.seleccion) {
                            //Establecemos la imagen del héroe a la casilla seleccionada por el usuario
                            adapter.getItem(i).setImagen(R.drawable.heroe_estrella);
                            ...
                            if (adapter.getItem(posHeroe).getImagen() == R.drawable.heroe_estrella) {
                            ...
                            if (adapter.getItem(i).getFila() == 9 && adapter.getItem(i).getColumna() == 9) {
                                ...
                                for (int j = 0; j < grid.getCount(); j++) {
                                    adapter.getItem(j).setImagen(R.drawable.heroe_estrella);
                                }
                                ...
                                BdPartidas bdPartidas = new BdPartidas(JuegoEstrellaActivity.this);
